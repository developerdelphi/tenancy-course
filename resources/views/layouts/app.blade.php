...
<html lang="en">
    ...
    <head>
        ...
        <title>RapidCourses .:: @yield('title') ::.</title>

        <script src="https://cdn.tailwindcss.com?plugins=forms,typography,aspect-ratio,line-clamp"></script>
    </head>

    <body class="bg-gray-100 text-gray-800 fkex flex-col items-stretch">
        <header class="h-12 bg-gray-300 flex flex-row items-center w-full">
            @yield('menu-page')
        </header>
